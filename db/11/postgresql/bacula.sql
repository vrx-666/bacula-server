...
--
-- Name: events; Type: TABLE; Schema: public; Owner: bacula
--
...
CREATE TABLE public.events (
    ...
    eventsdaemon text DEFAULT ''::text,
    eventssource text DEFAULT ''::text,
    eventsref text DEFAULT ''::text,
    eventstext text NOT NULL
);


ALTER TABLE public.events OWNER TO bacula;

--
-- Name: events_eventsid_seq; Type: SEQUENCE; Schema: public; Owner: bacula
--
...
ALTER TABLE public.events_eventsid_seq OWNER TO bacula;

--
-- Name: events_eventsid_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: bacula
--
...
--
-- Name: filemedia; Type: TABLE; Schema: public; Owner: bacula
--

CREATE TABLE public.filemedia (
    jobid integer NOT NULL,
...
ALTER TABLE public.filemedia OWNER TO bacula;
...
--
-- Name: object; Type: TABLE; Schema: public; Owner: bacula
--
...
ALTER TABLE public.object OWNER TO bacula;

--
-- Name: object_objectid_seq; Type: SEQUENCE; Schema: public; Owner: bacula
--
...
ALTER TABLE public.object_objectid_seq OWNER TO bacula;

--
-- Name: object_objectid_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: bacula
--
...
--
-- Name: tagclient; Type: TABLE; Schema: public; Owner: bacula
--

CREATE TABLE public.tagclient (
    clientid integer NOT NULL,
    tag text NOT NULL
);


ALTER TABLE public.tagclient OWNER TO bacula;

--
-- Name: tagjob; Type: TABLE; Schema: public; Owner: bacula
--

CREATE TABLE public.tagjob (
    jobid integer NOT NULL,
    tag text NOT NULL
);


ALTER TABLE public.tagjob OWNER TO bacula;

--
-- Name: tagmedia; Type: TABLE; Schema: public; Owner: bacula
--

CREATE TABLE public.tagmedia (
    mediaid integer NOT NULL,
    tag text NOT NULL
);


ALTER TABLE public.tagmedia OWNER TO bacula;

--
-- Name: tagobject; Type: TABLE; Schema: public; Owner: bacula
--

CREATE TABLE public.tagobject (
    objectid integer NOT NULL,
    tag text NOT NULL
);


ALTER TABLE public.tagobject OWNER TO bacula;
...
--
-- Name: events eventsid; Type: DEFAULT; Schema: public; Owner: bacula
--
...
--
-- Name: object objectid; Type: DEFAULT; Schema: public; Owner: bacula
--
...
--
-- Data for Name: events; Type: TABLE DATA; Schema: public; Owner: bacula
--

COPY public.events (eventsid, eventscode, eventstype, eventstime, eventsinserttime, eventsdaemon, eventssource, eventsref, eventstext) FROM stdin;
\.
...
COPY public.file (fileid, fileindex, jobid, pathid, filename, deltaseq, markid, lstat, md5) FROM stdin;
\.


--
-- Data for Name: filemedia; Type: TABLE DATA; Schema: public; Owner: bacula
--

COPY public.filemedia (jobid, fileindex, mediaid, blockaddress, recordno, fileoffset) FROM stdin;
\.
...
COPY public.job (jobid, job, name, type, level, clientid, jobstatus, schedtime, starttime, endtime, realendtime, jobtdate, volsessionid, volsessiontime, jobfiles, jobbytes, readbytes, joberrors, jobmissingfiles, poolid, filesetid, priorjobid, priorjob, purgedfiles, hasbase, hascache, reviewed, comment, filetable) FROM stdin;
\.
...
COPY public.jobhisto (jobid, job, name, type, level, clientid, jobstatus, schedtime, starttime, endtime, realendtime, jobtdate, volsessionid, volsessiontime, jobfiles, jobbytes, readbytes, joberrors, jobmissingfiles, poolid, filesetid, priorjobid, priorjob, purgedfiles, hasbase, hascache, reviewed, comment, filetable) FROM stdin;
\.
...
--
-- Data for Name: object; Type: TABLE DATA; Schema: public; Owner: bacula
--

COPY public.object (objectid, jobid, path, filename, pluginname, objecttype, objectname, objectsource, objectuuid, objectsize) FROM stdin;
\.
...
COPY public.pool (poolid, name, numvols, maxvols, useonce, usecatalog, acceptanyvolume, volretention, cacheretention, voluseduration, maxvoljobs, maxvolfiles, maxvolbytes, maxpoolbytes, autoprune, recycle, actiononpurge, pooltype, labeltype, labelformat, enabled, scratchpoolid, recyclepoolid, nextpoolid, migrationhighbytes, migrationlowbytes, migrationtime) FROM stdin;
\.
...
--
-- Data for Name: tagclient; Type: TABLE DATA; Schema: public; Owner: bacula
--

COPY public.tagclient (clientid, tag) FROM stdin;
\.


--
-- Data for Name: tagjob; Type: TABLE DATA; Schema: public; Owner: bacula
--

COPY public.tagjob (jobid, tag) FROM stdin;
\.


--
-- Data for Name: tagmedia; Type: TABLE DATA; Schema: public; Owner: bacula
--

COPY public.tagmedia (mediaid, tag) FROM stdin;
\.


--
-- Data for Name: tagobject; Type: TABLE DATA; Schema: public; Owner: bacula
--

COPY public.tagobject (objectid, tag) FROM stdin;
\.
...
COPY public.unsavedfiles (unsavedid, jobid, pathid, filename) FROM stdin;
\.
...
--
-- Name: events_eventsid_seq; Type: SEQUENCE SET; Schema: public; Owner: bacula
--
...
--
-- Name: object_objectid_seq; Type: SEQUENCE SET; Schema: public; Owner: bacula
--

SELECT pg_catalog.setval('public.object_objectid_seq', 1, false);
...
--
-- Name: events events_pkey; Type: CONSTRAINT; Schema: public; Owner: bacula
--
...
--
-- Name: object object_pkey; Type: CONSTRAINT; Schema: public; Owner: bacula
--
...
--
-- Name: tagclient tagclient_pkey; Type: CONSTRAINT; Schema: public; Owner: bacula
--

ALTER TABLE ONLY public.tagclient
    ADD CONSTRAINT tagclient_pkey PRIMARY KEY (clientid, tag);


--
-- Name: tagjob tagjob_pkey; Type: CONSTRAINT; Schema: public; Owner: bacula
--

ALTER TABLE ONLY public.tagjob
    ADD CONSTRAINT tagjob_pkey PRIMARY KEY (jobid, tag);


--
-- Name: tagmedia tagmedia_pkey; Type: CONSTRAINT; Schema: public; Owner: bacula
--

ALTER TABLE ONLY public.tagmedia
    ADD CONSTRAINT tagmedia_pkey PRIMARY KEY (mediaid, tag);


--
-- Name: tagobject tagobject_pkey; Type: CONSTRAINT; Schema: public; Owner: bacula
--

ALTER TABLE ONLY public.tagobject
    ADD CONSTRAINT tagobject_pkey PRIMARY KEY (objectid, tag);
...
--
-- Name: events_time_idx; Type: INDEX; Schema: public; Owner: bacula
--

CREATE INDEX events_time_idx ON public.events USING btree (eventstime);
...
CREATE INDEX file_jpfid_idx ON public.file USING btree (jobid, pathid, filename text_pattern_ops);


--
-- Name: file_media_idx; Type: INDEX; Schema: public; Owner: bacula
--

CREATE INDEX file_media_idx ON public.filemedia USING btree (jobid, fileindex);
...
--
-- Name: object_jobid_idx; Type: INDEX; Schema: public; Owner: bacula
--

CREATE INDEX object_jobid_idx ON public.object USING btree (jobid);


--
-- Name: object_name_idx; Type: INDEX; Schema: public; Owner: bacula
--

CREATE INDEX object_name_idx ON public.object USING btree (objectname);


--
-- Name: object_source_idx; Type: INDEX; Schema: public; Owner: bacula
--

CREATE INDEX object_source_idx ON public.object USING btree (objectsource);


--
-- Name: object_type_idx; Type: INDEX; Schema: public; Owner: bacula
--

CREATE INDEX object_type_idx ON public.object USING btree (objecttype);
